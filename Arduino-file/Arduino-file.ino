...
#define DATABASE_URL "nodemcu-f540d-default-rtdb.asia-southeast1.firebasedatabase.app" //<databaseName>.firebaseio.com or <databaseName>.<region>.firebasedatabase.app
#define DATABASE_SECRET "3tAcPntofpPYoFRmjMQfMVBJfPmmdJChOMC3G1YU"
